...
export { action as login, selector as loginSelector, metaSelector as loginMetaSelector } from './redux/entities/login';
...
export { action as register, selector as registerSelector, metaSelector as registerMetaSelector } from './redux/entities/register';
